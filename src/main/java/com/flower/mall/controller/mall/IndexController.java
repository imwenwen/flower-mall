...
public class IndexController {
    ...
    public String indexPage(HttpServletRequest request) {
        //查询轮播图 默认5张
        List<FlowerMallIndexCarouselVO> carousels = flowerMallCarouselService.getCarouselsBy(5);
        //查询热门花花 默认5个
        List<FlowerMallIndexConfigGoodsVO> hotGoods = flowerMallIndexConfigService.getConfigGoodsBy(IndexConfigTypeEnum.INDEX_GOODS_HOT.getType(), 5);
        //查询新品花花 默认5个
        List<FlowerMallIndexConfigGoodsVO> newGoods = flowerMallIndexConfigService.getConfigGoodsBy(IndexConfigTypeEnum.INDEX_GOODS_NEW.getType(), 5);
        //查询推荐花花 默认5个
        List<FlowerMallIndexConfigGoodsVO> recommendGoods = flowerMallIndexConfigService.getConfigGoodsBy(IndexConfigTypeEnum.INDEX_GOODS_RECOMMOND.getType(), 10);
        //轮播图
