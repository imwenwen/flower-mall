    ...
    public List<FlowerMallShoppingCartItemVO> getMyShoppingCartItems(Long newBeeMallUserId) {
        ...
        if (!CollectionUtils.isEmpty(newBeeMallShoppingCartItems)) {
            ...
            for (NewBeeMallShoppingCartItem newBeeMallShoppingCartItem : newBeeMallShoppingCartItems) {
                ...
                BeanUtil.copyProperties(newBeeMallShoppingCartItem, flowerMallShoppingCartItemVO);
                if (newBeeMallGoodsMap.containsKey(newBeeMallShoppingCartItem.getGoodsId())) {
                    ...
                    flowerMallShoppingCartItemVO.setGoodsCoverImg(newBeeMallGoodsTemp.getGoodsCoverImg());
                    ...
                    flowerMallShoppingCartItemVO.setSellingPrice(newBeeMallGoodsTemp.getSellingPrice());
