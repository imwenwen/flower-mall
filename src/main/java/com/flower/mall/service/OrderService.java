...
public interface OrderService {
     ...
     * @return
     */
    String saveOrder(FlowerMallUserVO user, List<FlowerMallShoppingCartItemVO> myShoppingCartItems);
     ...
     * @return
     */
    FlowerMallOrderDetailVO getOrderDetailByOrderNo(String orderNo, Long userId);
    ...
    List<FlowerMallOrderItemVO> getOrderItems(Long id);
}
